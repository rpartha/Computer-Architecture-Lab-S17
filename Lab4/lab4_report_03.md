...
1. Please refer to *quad_sol_reordered.asm* for this assignment.
  ...
  First block:  
  ![First Block](C:\Ram\GITHUB\Computer-Architecture-Lab-S17\Lab4\block1.PNG)

  First block [REORDERED]:  
  ![First Block REORDERED](C:\Ram\GITHUB\Computer-Architecture-Lab-S17\Lab4\block1new.PNG)

  The reordered first block would take 12 cycles < 14 cycles = original first block.

  Second block:  
  ![Second Block](C:\Ram\GITHUB\Computer-Architecture-Lab-S17\Lab4\block2.PNG)

  Second block [REORDERED]:  
  ![Second Block REORDERED](C:\Ram\GITHUB\Computer-Architecture-Lab-S17\Lab4\block2new.PNG)
